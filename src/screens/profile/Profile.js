...
function FavoriteBorderIcon(props) {
    return ( <
        ...
        2 8.5 c0 3.78 3.4 6.86 8.55 11.54 L12 21.35 l1 .45 - 1.32 C18 .6 15.36 22 12.28 22 8.5 22 5.42 19.58 3 16.5 3 zm - 4.4 15.55 l - .1 .1 - .1 - .1 C7 .14 14.24 4 11.39 4 8.5 4 6.5 5.5 5 7.5 5 c1 .54 0 3.04 .99 3.57 2.36 h1 .87 C13 .46 5.99 14.96 5 16.5 5 c2 0 3.5 1.5 3.5 3.5 0 2.89 - 3.14 5.74 - 7.9 10.05 z " /> <
        /SvgIcon>
    );
}
...
function FavoriteIcon(props) {
    return ( <
        ...
        3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5 c0 3.78 - 3.4 6.86 - 8.55 11.54 L12 21.35 z " /> <
        /SvgIcon>
    );
}
...
class Profile extends Component {
    ...
    UNSAFE_componentWillMount() {
        ...
        xhrEndPt1.open("GET", this.props.baseUrl + "?access_token=86610sdf35776.d0dfdfcd39.39f6dfd3ab2f88d4f9c92dfb0862729dfeedf784");
        xhrEndPt1.send(null);
        ...
        xhrEndPt2.open("GET", this.props.baseUrl + "media/recent?access_token=86610sdf35776.d0dfdfcd39.39f6dfd3ab2f88d4f9c92dfb0862729dfeedf784");
        xhrEndPt2.send(null);
        ...
        return ( <
            ...
            /> {
                ...
                className = { classes.gridListMain } > {
                        this.state.userImages.map(images => ( <
                            GridListTile onClick = {
                                () => this.onImageClickHandler(images) }
                            className = "postedImages-grid-item"
                            key = { images.id } >
                            <
                            img src = { images.images.standard_resolution.url }
                            className = "image-posts"
                            alt = { images.caption.text }
                            /> <
                            /GridListTile>
                        ))
                    } <
                ...
                style = { CustomStyles } >
                    ...
                    <
                    img src = { this.state.clickedImg }
                className = "clickedImg"
                alt = { this.state.clickedImgCaption }
                /> <
                /div> <
                div className = "rightModal" >
                    ...
                    <
                    span > < img src = { this.state.clickedImgProfilePic }
                className = "userProfilePic"
                alt = { this.state.clickedImgUserName }
                /></span >
                <
                ...
                div className = "modalBody" >
                    ...
                    h4 className = "captionText" > {
                        (this.state.clickedImgCaption).split("#")[0] } < /h4> {
                ...
                div className = "likeSection" >
                    <
                    span onClick = {
                        () => this.setState({ favClick: !this.state.favClick }) } > {
                        this.state.favClick === true ? < div >
                        <
                        span className = "favIcon" > < FavoriteIcon className = { classes.icon }
                        /></span >
                        <
                        span className = "like" > { " " + (this.state.clickedImgLikes) - 1 }
                        likes < /span> </div > :
                            <
                            div > < span > < FavoriteBorderIcon className = { classes.icon }
                        /></span >
                        <
                        span className = "like" > { " " + (this.state.clickedImgLikes) + 1 }
                        likes < /span></div >
                ...
                onChange = {
                    (event) => this.onCommentChangeHandler(event, this.state.clickedImgId) }
                ...
                className = "AddBtn"
                onClick = {
                        () => this.onClickAddBtn(this.state.clickedImgId) } >
                    ADD <
                    /Button> <
                    /div> <
                    /div> <
